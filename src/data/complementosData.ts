...
export const adicionais: SecaoComplemento = {
  ...
  tipo: "pago",
  itens: [
    { id: "uva-a", nome: "Uva", preco: 0.70, imagem: uva, maxQuantidade: 15 },
    { id: "banana-a", nome: "Plátano", preco: 0.70, imagem: banana, maxQuantidade: 15 },
    { id: "kiwi-a", nome: "Kiwi", preco: 0.70, imagem: kiwi, maxQuantidade: 15 },
    { id: "abacaxi-a", nome: "Piña", preco: 0.70, imagem: abacaxi, maxQuantidade: 15 },
    { id: "leite-ninho-a", nome: "Leche Ninho", preco: 0.90, imagem: leiteNinho, maxQuantidade: 15 },
    { id: "ovomaltine-a", nome: "Ovomaltine", preco: 0.90, imagem: ovomaltine, maxQuantidade: 15 },
    { id: "leite-condensado-a", nome: "Leche condensada", preco: 0.90, imagem: leiteCondensado, maxQuantidade: 15 },
    { id: "ouro-branco-a", nome: "Ouro Branco", preco: 1.00, imagem: ouroBranco, maxQuantidade: 15 },
    { id: "bis-preto-a", nome: "Bis negro", preco: 1.00, imagem: bisPreto, maxQuantidade: 15 },
    { id: "bis-branco-a", nome: "Bis blanco", preco: 1.00, imagem: bisBranco, maxQuantidade: 15 },
    { id: "sonho-valsa-a", nome: "Sonho de Valsa", preco: 1.00, imagem: sonhoValsa, maxQuantidade: 15 },
    { id: "mms-a", nome: "M&M's", preco: 1.00, imagem: mms, maxQuantidade: 15 },
    { id: "granola-a", nome: "Granola", preco: 0.80, imagem: granola, maxQuantidade: 15 },
    { id: "pacoca-a", nome: "Paçoca", preco: 0.80, imagem: pacoca, maxQuantidade: 15 },
    { id: "kitkat-preto-a", nome: "Kit Kat negro", preco: 1.20, imagem: kitkatPreto, maxQuantidade: 15 },
    { id: "kitkat-branco-a", nome: "Kit Kat blanco", preco: 1.20, imagem: kitkatBranco, maxQuantidade: 15 },
    { id: "gomets-a", nome: "Gomets", preco: 0.80, imagem: gomets, maxQuantidade: 15 },
    { id: "cobertura-morango-a", nome: "Cobertura de fresa", preco: 0.70, imagem: coberturaMorango, maxQuantidade: 15 },
    { id: "cobertura-chocolate-a", nome: "Cobertura de chocolate", preco: 0.70, imagem: caldaChocolate, maxQuantidade: 15 },
    { id: "cobertura-caramelo-a", nome: "Cobertura de caramelo", preco: 0.70, imagem: coberturaCaramelo, maxQuantidade: 15 },
    { id: "chocoboll-a", nome: "Chocoboll", preco: 0.80, imagem: chocoboll, maxQuantidade: 15 },
    { id: "amendoim-a", nome: "Cacahuete", preco: 0.70, imagem: amendoim, maxQuantidade: 15 },
  ]
};
...
export const adicionaisPremium: SecaoComplemento = {
  ...
  tipo: "premium",
  itens: [
    { id: "morango-p", nome: "Fresa", preco: 0.90, imagem: morango, maxQuantidade: 15 },
    { id: "creme-avela-p", nome: "Crema de avellana", preco: 1.50, imagem: cremeAvela, maxQuantidade: 15 },
    { id: "nutela-p", nome: "Nutella", preco: 1.90, imagem: nutela, maxQuantidade: 15 },
    { id: "creme-leite-ninho-p", nome: "Crema de leche Ninho", preco: 1.50, imagem: cremeLeiteNinho, maxQuantidade: 15 },
    { id: "creme-morango-p", nome: "Crema de fresa", preco: 1.50, imagem: cremeMorango, maxQuantidade: 15 },
    { id: "creme-cookies-p", nome: "Crema de galletas", preco: 1.50, imagem: cremeCookies, maxQuantidade: 15 },
  ]
};
